...
struct TransactionsTip: Tip {
    var title: Text { Text("tip.transactions.title") }
    var message: Text? { Text("tip.transactions.message") }
...
struct AccountsTip: Tip {
    var title: Text { Text("tip.accounts.title") }
    var message: Text? { Text("tip.accounts.message") }
...
struct CategoriesTip: Tip {
    var title: Text { Text("tip.categories.title") }
    var message: Text? { Text("tip.categories.message") }
...
struct PeriodsTip: Tip {
    var title: Text { Text("tip.periods.title") }
    var message: Text? { Text("tip.periods.message") }
...
struct SubscriptionsTip: Tip {
    var title: Text { Text("tip.subscriptions.title") }
    var message: Text? { Text("tip.subscriptions.message") }
...
struct VendorsTip: Tip {
    var title: Text { Text("tip.vendors.title") }
    var message: Text? { Text("tip.vendors.message") }
